...
export const ColorBoxSettingsModal = () => {
    const { set_cb_setting_AllowHover, cb_setting_AllowHover, cb_setting_RefreshInterval, set_cb_setting_RefreshInterval, cb_setting_AnimationTime, set_cb_setting_AnimationTime } = useColorBoxContext()
